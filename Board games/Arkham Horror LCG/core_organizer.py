...
CLUES_BOX_OUTER_WIDTH = CAPSULES_BOX_OUTER_WIDTH
CLUES_BOX_OUTER_LENGTH = BOX_WIDTH - STANDEES_BOX_OUTER_LENGTH - CAPSULES_BOX_OUTER_LENGTH - CHAOS_TOKEN_BOX_OUTER_LENGTH
CLUES_BOX_OUTER_HEIGHT = CHAOS_TOKEN_BOX_OUTER_HEIGHT
...
RESOURCES_BOX_OUTER_HEIGHT = BOX_HEIGHT - CHAOS_BAG_HEIGHT - CHAOS_TOKEN_BOX_OUTER_HEIGHT


print("--- Stats ---")
print(f"Box length gap: {BOX_LENGTH - 2 * CARDS_BOX_OUTER_WIDTH - STANDEES_BOX_OUTER_WIDTH}")
print(f"Box width gap: {BOX_WIDTH - STANDEES_BOX_OUTER_LENGTH - CAPSULES_BOX_OUTER_LENGTH - CLUES_BOX_OUTER_LENGTH - CHAOS_TOKEN_BOX_OUTER_LENGTH}")
...
def clues_box():
  return two_section_box(CLUES_BOX_OUTER_WIDTH, CLUES_BOX_OUTER_LENGTH, CLUES_BOX_OUTER_HEIGHT)
...
cq.exporters.export(clues_box(), 'clues_box.stl')
